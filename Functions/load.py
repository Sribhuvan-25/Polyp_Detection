...
# Load the data
# polyp_folder = 'patches_for_training'
# non_polyp_folder = 'normal_patches_from_abnormal_images_new_3'
polyp_folder = 'Data/abnormal'
non_polyp_folder = 'Data/normal'
images, labels = load_data(polyp_folder, non_polyp_folder)
...
split_and_copy_images(normal_dir, os.path.join(train_dir, 'normal'), os.path.join(test_dir, 'normal'), 410)

# Split and copy abnormal images
split_and_copy_images(abnormal_dir, os.path.join(train_dir, 'abnormal'), os.path.join(test_dir, 'abnormal'), 410)
